...
async function main() {
    ...
    const brands = ['RaihanShop Brands', 'Apple', 'Nike', 'IKEA', 'Sony'];
    const brandMap = {};
        ...
        for (let i = 1; i <= 12; i++) {
            ...
            await prisma.product.upsert({
                ...
                create: {
                    ...
                    brandId: brandMap['RaihanShop Brands'],
    ...
    const featured = [
        { name: 'iPhone 15 Pro Max', slug: 'iphone-15-pro-max', price: 124999, salePrice: 114999, image: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&h=400&fit=crop', images: JSON.stringify(['https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&h=400&fit=crop', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&h=800&fit=crop']), brandId: brandMap['Apple'], productCode: 'RS-IP15', status: 'In Stock', stockQuantity: 25, shortDescription: 'The ultimate iPhone experience with a groundbreaking new camera system and A17 Pro chip.', features: JSON.stringify([{ label: 'Display', value: '6.7-inch Super Retina XDR' }, { label: 'Processor', value: 'A17 Pro Bionic' }]), categoryId: categoryMap['Electronics'] },
        { name: 'Nike Air Max 270', slug: 'nike-air-max-270', price: 8500, salePrice: 6999, image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop', images: JSON.stringify(['https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop', 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=400&h=400&fit=crop']), brandId: brandMap['Nike'], productCode: 'RS-NK270', status: 'In Stock', stockQuantity: 40, shortDescription: 'Visible cushioning under every step.', features: JSON.stringify([{ label: 'Material', value: 'Breathable Mesh' }]), categoryId: categoryMap['Sneakers'] },
        { name: 'Minimalist Wood Desk', slug: 'minimalist-wood-desk', price: 12500, salePrice: null, image: 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=400&h=400&fit=crop', images: JSON.stringify(['https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=400&h=400&fit=crop']), brandId: brandMap['IKEA'], productCode: 'RS-WD100', status: 'In Stock', stockQuantity: 10, shortDescription: 'Beautiful minimalist wooden desk for any modern home office.', features: JSON.stringify([{ label: 'Material', value: 'Solid Oak Wood' }]), categoryId: categoryMap['Home and Living'] },
        { name: 'Sony WH-1000XM5', slug: 'sony-wh-1000xm5', price: 35000, salePrice: 32000, image: 'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=400&h=400&fit=crop', images: JSON.stringify(['https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=400&h=400&fit=crop']), brandId: brandMap['Sony'], productCode: 'RS-SNYXM5', status: 'In Stock', stockQuantity: 30, shortDescription: 'Industry-leading noise cancellation headphones.', features: JSON.stringify([{ label: 'Battery', value: 'Up to 30 hours' }]), categoryId: categoryMap['Electronics'] },
    ];
